from DLRT_huggingface_transformers.LoRABUGDLRT import LoRABUGDLRT
from DLRT_huggingface_transformers.LoRAParallelDLRT import LoRAParallelDLRT
from DLRT_huggingface_transformers.LoRALinear import LoRALinear
from DLRT_huggingface_transformers.LoRAFullFT import LoRAFullFT
...
def get_custom_peft(
    ...
    for name, original_linear in linear_replacements:
        ...
        if name == "classifier":
            ...
            if peft_module == "LoRABUGDLRT":
                lora_module = LoRABUGDLRT(
                    original_linear,
                    rank=rank,
                    alpha=alpha,
                    max_rank=max_rank,
            ...
            elif peft_module == "LoRAParallelDLRT":
            ...
            elif peft_module == "LoRALinear":
                lora_module = LoRALinear(
                    original_linear, rank=rank, alpha=alpha, lora_dropout=lora_dropout
                )
            else:
                raise ValueError(
