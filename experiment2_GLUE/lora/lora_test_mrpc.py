...
def init_wandb(run_id):
    for attempt in range(3):  # Retry up to 3 times
        try:
            wandb.init(project="mrpc", name=f"run_{run_id}", reinit=True)
            return
...
for run in range(5):
    ...
    training_args = TrainingArguments(
        ...
        weight_decay=0.1,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L15
