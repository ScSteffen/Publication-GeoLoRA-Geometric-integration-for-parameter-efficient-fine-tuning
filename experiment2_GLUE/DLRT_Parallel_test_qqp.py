...
def tokenize_function(examples):
    return tokenizer(
        ...
        truncation=True,
        max_length=320,
    )  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L13
...
def init_wandb(run_id):
    for attempt in range(3):  # Retry up to 3 times
        try:
            wandb.init(project="qqp", name=f"parallel_run_{run_id}", reinit=True)
            return
...
for run in range(5):
    ...
    training_args = TrainingArguments(
        output_dir="./results/qqp/parallel",
        ...
        # resume_from_checkpoint="models/qqp/checkpoint-<specific_step>",
        eval_steps=400,
        # save_steps=1,
        load_best_model_at_end=False,
        learning_rate=8e-4,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L14
        # per_device_train_batch_size=32,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L14
        num_train_epochs=5,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L15
        weight_decay=0.01,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L16
        warmup_steps=2000,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L15
        seed=seed_value,
        logging_steps=500,
        #cls_dropout=0.15,
        report_to="wandb",
    ...
    #    r=8,
    #    lora_alpha=16,       #https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L11
    #    target_modules=[     #https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_qqp.sh#L10
    #        "query_proj", "key_proj", "value_proj",  # Attention heads
    #        "intermediate.dense", "output.dense",    # Feed-forward network
    ...
    with open(
        f"results/qqp/run_parallel_stsb_layer_ranks_run_{run + 1}.csv",
        mode="w",
        newline="",
    ) as file:
    ...
    print(
        f"CSV file 'results/qqp/run_parallel_qqp_layer_ranks_run_{run + 1}.csv' created successfully."
    )
    # Save the best model
    # est_model_checkpoint = trainer.state.best_model_checkpoint
    # f best_model_checkpoint is not None and os.path.exists(
