...
def tokenize_function(examples):
    return tokenizer(
        ...
        truncation=True,
        max_length=320,
    )  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L12
...
def init_wandb(run_id):
    for attempt in range(3):  # Retry up to 3 times
        try:
            wandb.init(project="mrpc", name=f"parallel_run_{run_id}", reinit=True)
            return
...
for run in range(5):
    ...
    training_args = TrainingArguments(
        output_dir="./results/mrpc/parallel",
        ...
        learning_rate=1e-3,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L13
        # per_device_train_batch_size=32,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L13
        num_train_epochs=40,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L14
        weight_decay=0.01,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L15
        warmup_ratio=0.1,  # https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L14
        seed=seed_value,
        logging_steps=100,
        report_to="wandb",
        logging_dir="./logs",
    ...
    #    r=8,
    #    lora_alpha=32,     #https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L11
    #    target_modules=[   #https://github.com/QingruZhang/AdaLoRA/blob/d10f5ebee16c478fa2f41a44a237b38e8c9b0338/NLU/scripts/run_debertav3_mrpc.sh#L10
    ...
    with open(
        f"results/mrpc/run_parallel_mrpc_layer_ranks_run_{run + 1}.csv",
        mode="w",
        newline="",
    ) as file:
    ...
    print(
        f"CSV file 'results/mrpc/run_parallel_mrpc_layer_ranks_run_{run + 1}.csv' created successfully."
    )
